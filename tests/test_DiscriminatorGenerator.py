from tests.context import unittest, os, DiscriminatorGenerator, Vocab

top = os.getcwd()

class TestDiscriminatorGenerator(unittest.TestCase):
    ...
    def test_discriminator_generator(self):
        ...
        self.assertEqual(x.shape, (gen.B, gen.T, gen.N), msg="x shape test")
        self.assertEqual(y.shape, (gen.B, gen.T, 1), msg="y shape test")
